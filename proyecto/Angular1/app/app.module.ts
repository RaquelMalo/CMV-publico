...
// Es IMPORTANTE el orden en que se ponen las rutas. SE TIENE que poner LAS MÁS ESPECÍFICAS primero y luego las MÁS GENERALES
 ...
 const appRoutes: Routes = [
  ...
  { path: '', component: GaleriaComponent }, // Sintaxis: { path: 'Nombre_Ruta', component: Nombre_Componente }
  { path: '', redirectTo: '/', pathMatch: 'full' },  // Con REDIRECT para página de Inicio de la Aplicación
